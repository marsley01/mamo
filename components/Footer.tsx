      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-1">
            <Link href="/" className="font-heading text-3xl font-semibold tracking-tight text-slate-50" aria-label="Mamo Collections Home">
              Mamo Collections
            </Link>
            ...
            <div className="mt-6 flex gap-4">
              <a href="https://wa.me/254725907608" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-primary transition-colors" aria-label="WhatsApp">
          ...
          <div>
            <h3 className="font-heading text-lg font-medium text-slate-50 mb-4">Shop</h3>
          ...
          <div>
            <h3 className="font-heading text-lg font-medium text-slate-50 mb-4">Support</h3>
            <ul className="space-y-3" role="list">
              {footerLinks.support.map((link) => (
                <li key={link.label}>
                  <a href={link.href} className="text-slate-400 hover:text-primary transition-colors text-sm" target={link.href.startsWith('http') ? '_blank' : undefined} rel={link.href.startsWith('http') ? 'noopener noreferrer' : undefined}>
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-heading text-lg font-medium text-slate-50 mb-4">Company</h3>
            <ul className="space-y-3" role="list">
